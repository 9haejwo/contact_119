...
object ContactItemManager {
    ...
    init {
        ...
        addContent("대동병원 지역응급의료센터", "051-550-9390", "부산 동래구 충렬대로 187", BUSAN, R.drawable.daedong_pic, R.drawable.daedong_logo)
        addContent("삼육부산병원 응급실", "051-600-7575", "부산 서구 대티로 170",BUSAN, R.drawable.samyuk_busan_pic, R.drawable.samyuk_busan_logo)
        addContent("좋은문화병원 응급실", "051-630-0909", "부산 동구 범일로 119",BUSAN, R.drawable.good_culture_pic, R.drawable.good_culture_logo)
        addContent("충남대학교병원 응급센터", "042-280-8129", "대전 중구 문화로 282", DAEJEON, R.drawable.chungnam_univ_pic, R.drawable.chungnam_univ_logo)
        addContent("을지대학교병원 응급실", "042-259-1119", "대전 서구 둔산서로 95", DAEJEON, R.drawable.ulji_univ_pic, R.drawable.ulji_univ_logo)
        addContent("건양대학교병원 권역응급의료센터", "042-600-9119", "대전 서구 관저동로 158", DAEJEON,  R.drawable.konyang_univ_pic, R.drawable.konyang_univ_logo)
        addContent("경북대학교병원 응급실", "053-200-5114", "대구 중구 동덕로 130", DAEGU, R.drawable.kyungpook_univ_pic, R.drawable.kyungpook_univ_logo)
        addContent("나사렛종합병원 응급실", "0507-1457-3119", "대구 달서구 월배로 97", DAEGU, R.drawable.nazareth_pic, R.drawable.nazareth_logo)
        addContent("대구가톨릭대학교병원 응급의료센터", "053-650-4194", "대구 남구 두류공원로17길 33", DAEGU, R.drawable.daegu_catholic_univ_pic, R.drawable.daegu_catholic_univ_logo)
    }
    ...
    fun sortFavoriteWithHeader(): MutableList<ContactItems> {
        ...
        for (i in headerList) {
            if (contactItems.any { it.location == i.location && it is ContactItems.Contents && it.favorite}) {
                temp += i
                contactItems.forEach {
                    if (it is ContactItems.Contents && it.location == i.location && it.favorite) {
                        temp += it.copy()
                    }
                }
            }
